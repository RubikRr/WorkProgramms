...
(5, 'Педагогическое образование (с двумя профилями подготовки)', '44.03.05', 'Математика. Информатика.', 1),
(6, 'Прикладная математика и информатика', '01.04.02', 'Математическое и информационное обеспечение производственной деятельности', 2),
(7, 'Прикладная математика и информатика', '01.04.02', 'Математическое моделирование', 2),
(8, 'Математика', '01.04.01', 'Алгебра и анализ', 2);
...
INSERT INTO `edu_forms` (`id`, `title`) VALUES
(1,'Очная'),
(2,'Очно-заочная'),
(3,'Заочная');
-- --------------------------------------------------------
...
Insert into `block` (`id`,`block_title`,`part_title`) VALUES
(1,"Блок 1.Дисциплины (модули)","Обязательная часть"),
(2,"Блок 1.Дисциплины (модули)","Часть, формируемая участниками образовательных отношений"),
(3,"Блок 2.Практика","Обязательная часть"),
(4,"Блок 2.Практика","Часть, формируемая участниками образовательных отношений"),
(5,"Блок 3.Государственная итоговая аттестация","ФТД.Факультативы "),
(6,"Блок 1 «Дисциплины (модули)»","Базовая часть"),
(7,"Блок 1 «Дисциплины (модули)»","Вариативная часть"),
(8,"Блок 2 «Практики»","Вариативная часть"),
(9,"Блок 3 «Научные исследования»","Вариативная часть"),
(10,"Блок 4 «Государственная итоговая аттестация»","Базовая часть"),
(11,"ФТД.Факультативы",""),
(12,"Блок 3",""),
(13,"Блок 3.Государственная итоговая аттестация","");
-- --------------------------------------------------------
...
INSERT into `form_control` (`id`,`title`) VALUES
(1,"Экзамен"),
(2,"Зачет"),
(3,"Зачет с оц."),
(4,"КР");
...
CREATE TABLE `subjects` ( /*таблица Дисциплин*/
  `id` int(11) NOT NULL,
  `title` varchar(255) NOT NULL /*наименование дисциплины*/
) ENGINE=InnoDB DEFAULT CHARSET=cp1251;
