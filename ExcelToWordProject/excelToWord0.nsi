...
!define APPNAMEANDVERSION "ExcelToWordGrabber 0.1"

; Main Install settings
Name "${APPNAMEANDVERSION}"
InstallDir "$PROGRAMFILES\ExcelToWordGrabber"
InstallDirRegKey HKLM "Software\${APPNAME}" ""
OutFile "..\..\..\..\..\..\Program Files (x86)\Venis\Install.exe"
...
BrandingText "Тестовая версия граббера данных"
